...
class Player(pygame.sprite.Sprite):
    def __init__(self, playerX, playerY):
        ...
        self.sprites = []
        for c in range(9):
            imageLocal = f'./images/character{c}.png'
    ...
    def changeSide(self, side):
        if side == 'left':
            ...
            self.sprites = []
            for c in range(9):
                imageLocal = pygame.image.load('./images/character'+ str(c) +'.png')
    ...
    def walk(self, type):
        ...
        if self.currentSprite > 5 or self.currentSprite < 2:
...
# Control Panel    
bg = pygame.image.load('Tutorial 2 pygame/imagens/c2.png')
